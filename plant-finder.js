/* ============================================================
   ...
   v31 changes: tightened phase intervals to 1.2s — loader never reads
                as stuck on typical 4-5s mobile runs.
...
// Rotate phase messages while html2canvas works (3-6s typical, longer on mobile).
// Tight 1.2s intervals mean something always changes within ~1.5s — the loader
// never reads as stuck. Fast-device runs blow past the later phases harmlessly.
var phases = [
{at: 1200, phase: "Loading photographs"},
{at: 2400, phase: "Composing your plan"},
{at: 3600, phase: "Almost there"},
{at: 4800, phase: "Just a moment more"}
];
var phaseTimers = [];
