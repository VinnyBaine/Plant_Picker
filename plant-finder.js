/* ============================================================
   ...
   v30 changes: extended PDF loader phase rotation (added "Almost there"
                and "Just a moment more" for slow-mobile runs).
...
// Extra phases at 5.5s and 7.5s catch the slow-mobile case where the user
// would otherwise stare at "Composing your plan" for several seconds.
var phases = [
{at: 1500, phase: "Loading photographs"},
{at: 3500, phase: "Composing your plan"},
{at: 5500, phase: "Almost there"},
{at: 7500, phase: "Just a moment more"}
];
var phaseTimers = [];
